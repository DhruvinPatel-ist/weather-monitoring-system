...
import { useUsers } from "@/services/useUserManagement";
import { useUserMutations, useUserStatusMutation } from "@/hooks/useProfile";
...
export default function UserManagementPage({
  ...
  const handleSubmit = async (
    ...
    if (modalMode === "create") {
      ...
      await update.mutateAsync({ id: selectedUser.id, data: userData });
    }
    handleCloseModal();
  };
              ...
              {isLoading ? (
                ...
                paginatedUsers.map((user) => (
                  <tr key={user.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-3 md:px-4 py-3 flex items-center gap-2 whitespace-nowrap text-center">
                      <Switch
                        className="data-[state=checked]:bg-green-500 data-[state=unchecked]:bg-[#eaecf0] border border-gray-300"
